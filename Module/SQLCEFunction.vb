        ...
        Try
           ...
           & " VALUES ('BATCHID_SHIPPING_DO','','csssyyyyMM',NULL,1,1,3,GETDATE())"
            ...
            If Not "TblJSPSupplyInterface" = "" Then
                ...
                SQL.Append(",PDIO_NO NVARCHAR(4) ")
                SQL.Append(",DOCK_CODE NVARCHAR(4) ")
                SQL.Append(",PDIO_ORDER_TYPE NVARCHAR(4) ")
                ...
                SQL.Append(") ")
                If ExecuteSQL(SQL.ToString) = False Then
                    MsgBox("Failed to create table JSP Supply Inteface!", MsgBoxStyle.Critical, "Import")
                    Exit Function
                End If
                progressbar.Value = progressbar.Value + 2
            End If
